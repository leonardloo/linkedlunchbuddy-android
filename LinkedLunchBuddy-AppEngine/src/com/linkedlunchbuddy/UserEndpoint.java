...
@Api(name = "userendpoint", namespace = @ApiNamespace(ownerDomain = "linkedlunchbuddy.com", ownerName = "linkedlunchbuddy.com", packagePath = ""))
public class UserEndpoint {
	...
	private boolean containsUser(User user) {
		...
		try {
			if(user.getEduEmail() == null)
	            return false;
	        User item = mgr.find(User.class, user.getEduEmail());
	        if (item == null) {
	            contains = false;
			}
		} finally {
