...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "linkedlunchbuddy.com", ownerName = "linkedlunchbuddy.com", packagePath = ""))
public class DeviceInfoEndpoint {
	 ...
	 *
	 * @param id the primary key of the java bean. // Registration ID
